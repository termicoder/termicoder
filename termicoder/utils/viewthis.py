...
def view_problem(folder):
    browser_defaults_path=os.path.join(os.path.dirname(__file__),"browser_defaults.json")
    ...
    if(folder is None):
        ...
        problem_html_path=os.path.join(folder,problem["problem_code"]+".html")
